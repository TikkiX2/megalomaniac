            ...
            <div className="mx-auto flex w-full max-w-7xl flex-col gap-8 p-6 lg:p-8 animate-in fade-in duration-700">
                ...
                <div className="rounded-2xl bg-[#2b1a1a] border border-[#3e2121] p-6">
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
                        <select className="bg-[#1c0f0f] border-[#3e2121] text-white rounded-lg px-3 py-2 text-sm">
                        ...
                        <input type="date" className="bg-[#1c0f0f] border-[#3e2121] text-white rounded-lg px-3 py-2 text-sm" placeholder="From" />
                        <input type="date" className="bg-[#1c0f0f] border-[#3e2121] text-white rounded-lg px-3 py-2 text-sm" placeholder="To" />
                    </div>
                </div>
                            ...
                            {purchases.data.length > 0 ? (
                                purchases.data.map((p) => (
                                    <tr key={p.id} className="group hover:bg-white/[0.02] transition-colors">
                                        <td className="px-6 py-4">
                                            <span className="text-sm font-medium text-[#e8b4b4]">{new Date(p.purchase_date).toLocaleDateString()}</span>
                                        </td>
                                        <td className="px-6 py-4">
                                ...
                                <tr>
                                    <td colSpan={5} className="px-6 py-12 text-center">
                                        <p className="text-sm font-bold text-[#e8b4b4] uppercase italic">No purchases found.</p>
                                    </td>
                                </tr>
                            )}
                        </tbody>
