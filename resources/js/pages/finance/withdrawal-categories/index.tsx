...
import type { WithdrawalCategory } from '@/types/finance';
                ...
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    ...
                    <div className="rounded-2xl bg-[#2b1a1a] border border-[#3e2121] p-6 h-fit shadow-xl">
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                            ...
                            <div className="flex flex-col gap-1.5">
                                <Label htmlFor="color" className="text-[10px] font-black uppercase tracking-widest text-[#e8b4b4]">Color</Label>
                                <div className="flex gap-2">
                                    <Input
                                        ...
                                        className="bg-[#1c0f0f] border-[#3e2121] h-10 w-16 p-1 cursor-pointer"
                                        required
                                    />
                                    <Input
                                        value={data.color}
                                        onChange={e => setData('color', e.target.value)}
                                        className="bg-[#1c0f0f] border-[#3e2121] text-white h-10 uppercase"
                                        maxLength={7}
                                    />
                                </div>
                            </div>
                    ...
                    <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {categories.map((category) => (
                            <div key={category.id} className="relative overflow-hidden rounded-xl bg-[#2b1a1a] border border-[#3e2121] p-4 group hover:border-primary/30 transition-all">
                                <div className="flex items-center justify-between mb-2">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-[#e8b4b4] font-medium">{category.withdrawals_count} withdrawals</p>
                                        </div>
                                    </div>
