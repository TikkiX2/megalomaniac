...
import { WithdrawalCategory, Currency } from '@/types/finance';
            ...
            <div className="mx-auto flex w-full max-w-2xl flex-col gap-8 p-6 lg:p-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm font-medium text-[#92c9a4]">Record an expense or set up a recurring service.</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6 rounded-2xl bg-[#193322] border border-[#23482f] p-8 shadow-xl">
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div className="flex flex-col gap-2">
                            <Label htmlFor="category_id" className="text-xs font-black uppercase tracking-widest text-[#92c9a4]">Category</Label>
                            <div className="flex gap-2">
                                ...
                                <Link
                                    ...
                                    className="flex h-12 w-12 items-center justify-center rounded-md border border-[#23482f] bg-[#102216] text-[#92c9a4] hover:text-white hover:bg-white/5 transition-colors"
                        ...
                        <div className="flex flex-col gap-2">
                            <Label htmlFor="withdrawal_date" className="text-xs font-black uppercase tracking-widest text-[#92c9a4]">Date</Label>
                            <Input
                                id="withdrawal_date"
                                type="date"
                        ...
                        <div className="flex flex-col gap-4 md:col-span-2 rounded-xl bg-[#102216]/50 p-4 border border-[#23482f]/30">
                            ...
                            {data.is_recurring && (
                                <div className="grid grid-cols-1 gap-4 md:grid-cols-3 pt-2 animate-in fade-in duration-300">
                                    <div className="flex flex-col gap-2">
                                        <Label htmlFor="recurrence_frequency" className="text-[10px] font-black uppercase tracking-widest text-[#92c9a4]">Frequency</Label>
                                        <select
                                            id="recurrence_frequency"
                                            value={data.recurrence_frequency}
                                            onChange={e => setData('recurrence_frequency', e.target.value)}
                                            className="bg-[#102216] border-[#23482f] text-white rounded-md h-10 px-3 text-sm"
                                        >
                                    ...
                                    <div className="flex flex-col gap-2">
                                        <Label htmlFor="recurrence_day" className="text-[10px] font-black uppercase tracking-widest text-[#92c9a4]">Day</Label>
                                        <Input
                                            id="recurrence_day"
                                            type="number"
                                            min="1"
                        ...
                        <div className="flex flex-col gap-2 md:col-span-2">
                            <Label htmlFor="notes" className="text-xs font-black uppercase tracking-widest text-[#92c9a4]">Notes (Optional)</Label>
                            <Textarea
                                id="notes"
                                value={data.notes}
