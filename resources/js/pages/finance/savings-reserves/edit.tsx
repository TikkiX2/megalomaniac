        ...
        <MainLayout>
            ...
            <div className="mx-auto flex w-full max-w-2xl flex-col gap-8 p-6 lg:p-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                <div className="flex items-center gap-4">
                    <Link href={finance.savingsReserves.show(reserve.id).url} className="rounded-full p-2 hover:bg-white/5 text-[#e8b4b4] transition-all">
                        <span className="material-symbols-outlined">arrow_back</span>
                    </Link>
                    <div>
                        <h2 className="text-3xl font-black tracking-tight text-white">Edit Reserve</h2>
                        <p className="text-sm font-medium text-[#e8b4b4]">Modify your savings goal or account details.</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6 rounded-2xl bg-[#2b1a1a] border border-[#3e2121] p-8 shadow-xl">
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div className="flex flex-col gap-4 md:col-span-2 border-t border-[#3e2121]/50 pt-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex flex-col gap-0.5">
                                    ...
                                    <span className="text-xs text-[#e8b4b4]">Inactive reserves are archived and hidden from widgets.</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="flex gap-4 mt-4">
                        <Button
                            ...
                            className="flex-1 text-[#e8b4b4] hover:text-white hover:bg-white/5 font-bold h-14"
                        >
                            Cancel
                        </Button>
                        <Button
                            disabled={processing}
                            className="flex-[2] bg-primary px-8 py-6 text-base font-black text-white hover:bg-primary/90 shadow-[0_4px_20px_rgba(239,68,68,0.2)] h-14"
                        >
