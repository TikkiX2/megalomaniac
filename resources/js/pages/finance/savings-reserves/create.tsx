            ...
            <div className="mx-auto flex w-full max-w-2xl flex-col gap-8 p-6 lg:p-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm font-medium text-[#92c9a4]">Set up a new savings goal or account.</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6 rounded-2xl bg-[#193322] border border-[#23482f] p-8 shadow-xl">
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div className="flex flex-col gap-2">
                            <Label htmlFor="current_amount" className="text-xs font-black uppercase tracking-widest text-[#92c9a4]">Current Balance</Label>
                            <Input
                                id="current_amount"
                                type="number"
                                step="0.01"
