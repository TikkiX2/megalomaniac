        ...
        <MainLayout>
            ...
            <div className="mx-auto flex w-full max-w-5xl flex-col gap-8 p-6 lg:p-8 animate-in fade-in duration-700">
                <div className="flex items-center gap-4">
                    <Link href={finance.savingsReserves.index().url} className="rounded-full p-2 hover:bg-white/5 text-[#92c9a4] transition-all">
                        <span className="material-symbols-outlined">arrow_back</span>
                    </Link>
                    <div>
                        <h2 className="text-3xl font-black tracking-tight text-white">{reserve.name}</h2>
                        <p className="text-sm font-medium text-[#92c9a4]">{reserve.description || 'Savings Reserve Details'}</p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    ...
                    <div className="lg:col-span-2 flex flex-col gap-8">
                        <div
                            className="relative overflow-hidden rounded-3xl border border-[#23482f] bg-[#193322] p-8 shadow-2xl"
                        >
                            <div className="flex items-start justify-between">
                                <span className="text-sm font-black uppercase tracking-widest text-[#92c9a4]">Current Balance</span>
                                <div
                                    className="h-12 w-12 rounded-xl flex items-center justify-center shadow-lg"
                                    style={{ backgroundColor: reserve.color }}
                                >
                                    <span className="material-symbols-outlined text-[#102216] text-2xl font-bold">{reserve.icon || 'savings'}</span>
                                </div>
                            </div>
                            ...
                            <div className="mt-4 flex items-baseline gap-2">
                                ...
                                <span className="text-2xl font-bold text-[#92c9a4]">{reserve.currency?.code}</span>
                            </div>

                            {reserve.goal_amount && (
                                <div className="mt-8 flex flex-col gap-3">
                                    <div className="flex justify-between text-xs font-bold uppercase tracking-widest">
                                        <span className="text-[#92c9a4]">
                                    ...
                                    <div className="h-4 w-full rounded-full bg-[#102216] overflow-hidden">
                                        <div
                            ...
                            <div className="mt-8 flex gap-4">
                                <Button
                                    ...
                                    className="flex-1 bg-primary text-[#102216] font-black hover:bg-green-400 h-12"
                                >
                                ...
                                <Button
                                    ...
                                    className="flex-1 bg-[#102216] text-white border border-[#23482f] font-bold hover:bg-white/5 h-12"
                                >
                            ...
                            {actionType && (
                                <div className="mt-6 rounded-xl bg-[#102216]/50 p-6 border border-[#23482f] animate-in slide-in-from-top-4">
                                    ...
                                    <form onSubmit={handleTransaction} className="flex flex-col gap-4">
                                        <div className="grid grid-cols-2 gap-4">
                                            <div className="flex flex-col gap-1.5">
                                                <Label className="text-[10px] text-[#92c9a4] uppercase font-bold">Amount</Label>
                                                <Input
                                                    type="number" step="0.01"
                                                    value={data.amount} onChange={e => setData('amount', e.target.value)}
                                                    required className="bg-[#102216] border-[#23482f] text-white"
                                                    autoFocus
                                                />
                                            </div>
                                            <div className="flex flex-col gap-1.5">
                                                <Label className="text-[10px] text-[#92c9a4] uppercase font-bold">Date</Label>
                                                <Input
                                                    type="date"
                                        ...
                                        <div className="flex flex-col gap-1.5">
                                            <Label className="text-[10px] text-[#92c9a4] uppercase font-bold">Description (Optional)</Label>
                                            <Input
                                                value={data.description} onChange={e => setData('description', e.target.value)}
                                                className="bg-[#102216] border-[#23482f] text-white"
                        ...
                        <div className="rounded-3xl border border-[#23482f] bg-[#193322] p-8 shadow-xl">
                            ...
                            <div className="flex flex-col gap-4">
                                {reserve.transactions && reserve.transactions.length > 0 ? (
                                    reserve.transactions.map((tx) => (
                                        <div key={tx.id} className="flex items-center justify-between border-b border-[#23482f]/50 pb-4 last:border-0 last:pb-0">
                                            <div className="flex items-center gap-4">
                                                <div className={`flex h-10 w-10 items-center justify-center rounded-full ${tx.transaction_type === 'deposit' ? 'bg-green-500/10 text-green-500' : 'bg-rose-500/10 text-rose-500'}`}>
                                            ...
                                            <span className={`text-base font-black ${tx.transaction_type === 'deposit' ? 'text-green-500' : 'text-rose-500'}`}>
                    ...
                    <div className="flex flex-col gap-6">
                        <div className="rounded-2xl border border-[#23482f] bg-[#193322] p-6">
                            <h4 className="mb-4 text-xs font-black uppercase tracking-widest text-[#92c9a4]">Quick Actions</h4>
                            <div className="flex flex-col gap-2">
                                <Link
                                    href={finance.savingsReserves.edit(reserve.id).url}
                                    className="flex w-full items-center gap-3 rounded-lg bg-[#102216] px-4 py-3 text-sm font-bold text-gray-300 hover:bg-[#102216]/80 hover:text-white transition"
                                >
                                ...
                                <Link
                                    ...
                                    method="delete"
                                    as="button"
                                    className="flex w-full items-center gap-3 rounded-lg bg-[#102216] px-4 py-3 text-sm font-bold text-rose-500 hover:bg-rose-950/20 hover:text-rose-400 transition"
                                >
