                ...
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                            <div className="rounded-2xl bg-[#2b1a1a] border border-[#3e2121] p-5 flex flex-col gap-1 ring-1 ring-white/5">
                                <span className="text-[10px] font-black uppercase tracking-widest text-[#e8b4b4]">Remaining</span>
                            ...
                            <div className="rounded-2xl bg-[#2b1a1a] border border-[#3e2121] p-5 flex flex-col gap-1 ring-1 ring-white/5">
                                <span className="text-[10px] font-black uppercase tracking-widest text-[#e8b4b4]">Total Debt</span>
                            ...
                            <div className="rounded-2xl bg-[#2b1a1a] border border-[#3e2121] p-5 flex flex-col gap-1 ring-1 ring-white/5">
                                <span className="text-[10px] font-black uppercase tracking-widest text-[#e8b4b4]">Next Due Date</span>
                        ...
                        {/* Details Card */}
                        <div className="rounded-2xl bg-[#2b1a1a]/50 border border-[#3e2121] p-6 backdrop-blur-sm">
                            ...
                            <div className="grid grid-cols-2 gap-y-6 gap-x-12">
                                <div>
                                    <Label className="text-[10px] font-black uppercase tracking-widest text-[#e8b4b4] block mb-1">Principal</Label>
                                ...
                                <div>
                                    <Label className="text-[10px] font-black uppercase tracking-widest text-[#e8b4b4] block mb-1">Interest</Label>
                                ...
                                <div>
                                    <Label className="text-[10px] font-black uppercase tracking-widest text-[#e8b4b4] block mb-1">Tax</Label>
                                    <span className="text-base font-bold text-white">{debt.currency?.symbol} {parseFloat(debt.tax_amount as any).toLocaleString()}</span>
                                </div>
                                <div>
                                    <Label className="text-[10px] font-black uppercase tracking-widest text-[#e8b4b4] block mb-1">Credit Card</Label>
                                    {debt.credit_card ? (
                                ...
                                <div className="col-span-2">
                                    <Label className="text-[10px] font-black uppercase tracking-widest text-[#e8b4b4] block mb-1">Notes</Label>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-3">
                                {debt.payments?.length === 0 ? (
                                    <div className="rounded-xl border border-[#3e2121] border-dashed p-8 text-center text-[#e8b4b4] italic font-medium">
                                        No payments recorded yet.
                                    </div>
                                ) : (
                                    debt.payments?.map((p) => (
                                        <div key={p.id} className="flex items-center justify-between rounded-xl bg-[#2b1a1a] border border-[#3e2121] p-4 transition-all hover:bg-white/5">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="text-[10px] text-[#e8b4b4] italic">{p.notes || 'Direct payment'}</div>
                                                </div>
                                            </div>
                    ...
                    <div className="space-y-6">
                        {!isPaid && (
                            <div className="rounded-2xl bg-[#2b1a1a] border border-[#3e2121] p-6 shadow-xl ring-2 ring-primary/5">
                                ...
                                <form onSubmit={handlePayment} className="space-y-5">
                                    <div className="space-y-2">
                                        <Label htmlFor="amount" className="text-[10px] font-black uppercase tracking-widest text-[#e8b4b4]">Payment Amount</Label>
                                        <div className="relative">
                                            <span className="absolute left-3 top-1/2 -translate-y-1/2 text-[#e8b4b4] font-bold">{debt.currency?.symbol}</span>
                                            <Input
                                                id="amount"
                                                type="number"
                                                step="0.01"
                                                ...
                                                className="bg-[#1c0f0f] border-[#3e2121] text-white focus:ring-primary pl-10 h-12 font-black"
                                                placeholder="0.00"
                                                required
                                            />
                                        </div>
                                    ...
                                    <div className="space-y-2">
                                        <Label htmlFor="payment_date" className="text-[10px] font-black uppercase tracking-widest text-[#e8b4b4]">Date</Label>
                                        <Input
                                            id="payment_date"
                                            type="date"
                                    ...
                                    <div className="space-y-2">
                                        <Label htmlFor="notes" className="text-[10px] font-black uppercase tracking-widest text-[#e8b4b4]">Notes (Optional)</Label>
                                        <Input
                                            id="notes"
                                            value={data.notes}
                                    ...
                                    <Button
                                        disabled={processing}
                                        className="w-full bg-primary py-6 text-base font-black text-white hover:bg-primary/90 shadow-[0_4px_15_rgba(239,68,68,0.2)]"
                                    >
                                    ...
                                    <Button
                                        ...
                                        className="w-full bg-[#1c0f0f] border border-[#3e2121] py-4 text-[10px] font-black uppercase tracking-widest text-[#e8b4b4] hover:bg-white/5 transition-all"
                                    >
                                        Pay in Full
                                    </Button>
                                </form>
                        ...
                        <div className="rounded-2xl border border-[#3e2121] p-6 bg-white/[0.02]">
                            <h4 className="text-[10px] font-black uppercase tracking-widest text-[#e8b4b4] mb-4">Financial Advice</h4>
                            <p className="text-xs text-[#e8b4b4] leading-relaxed italic">
